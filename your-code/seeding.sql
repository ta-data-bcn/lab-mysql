...
Insert into customers (customer_id,customer_name,phone,email,address,city,state_province,country,postal)
Values
...
Insert into invoices (invoice_num,in_date,car_id,customer_id,salesperson_id)
Values
